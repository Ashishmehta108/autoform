...
--> statement-breakpoint
CREATE TABLE "updationTickets" (
	"ticketId" text PRIMARY KEY NOT NULL,
	"tickettype" text DEFAULT 'updationofbody'
);
--> statement-breakpoint
CREATE TABLE "apikey" (
	"id" text PRIMARY KEY NOT NULL,
...
ALTER TABLE "personaRequest" ADD CONSTRAINT "personaRequest_personaIdReqs_persona_personaId_fk" FOREIGN KEY ("personaIdReqs") REFERENCES "public"."persona"("personaId") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
